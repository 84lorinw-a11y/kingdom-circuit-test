...
console.info("Kingdom Circuit test build v5 loaded");
...
const TEST_BUILD = "v5";
const SUPPLEMENTAL_EVENTS_URL = `${BASE}supplemental-events-v5.json?v=5`;
...
const ARTIST_OVERRIDES = {
  "skema boy": {
    imageUrl: "assets/artists/skema-boy-v5.webp",
