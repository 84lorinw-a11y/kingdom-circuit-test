...
console.info("Kingdom Circuit test build v6 loaded");
...
const TEST_BUILD = "v6";
const SUPPLEMENTAL_EVENTS_URL = `${BASE}supplemental-events-v6.json?v=6`;
