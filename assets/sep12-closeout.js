...
(() => {
  ...
  function correctionPrefill() {
    ...
    if(details){details.required=true;const s=details.closest("label")?.querySelector("span");if(s)s.textContent="What needs to be corrected? Include a supporting link.";}
